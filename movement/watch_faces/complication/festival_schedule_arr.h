...
const schedule_t festival_acts[NUM_ACTS + 1]=
{
    [0] = {
        .artist = "EZBK  ",
        .stage = RANCH_ARENA,
        .start_time = {.unit.year = 3, .unit.month = 5, .unit.day = 20, .unit.hour = 15, .unit.minute = 0},
    ...
    [1] = {
        .artist = "POLTIK",
        .stage = RANCH_ARENA,
        .start_time = {.unit.year = 3, .unit.month = 6, .unit.day = 20, .unit.hour = 16, .unit.minute = 30},
    ...
    [5] = {
        .artist = "ODESZA",
        .stage = RANCH_ARENA,
        .start_time = {.unit.year = 3, .unit.month = 5, .unit.day = 20, .unit.hour = 23, .unit.minute = 45},
    ...
    [9] = {
        .artist = "SG LEW",
        .stage = SHERWOOD_COURT,
        .start_time = {.unit.year = 3, .unit.month = 5, .unit.day = 20, .unit.hour = 21, .unit.minute = 30},
        .end_time = {.unit.year = 4, .unit.month = 6, .unit.day = 20, .unit.hour = 22, .unit.minute = 30},
        .genre = INDIE,
    },
    [10] = {
